...
class ZoteroLocalAPI:
    ...
    def _sync_paper_item(self, db_session, item: Dict) -> Tuple[bool, bool]:
        ...
        if existing_paper:
            ...
            # Create new paper (already added to session in _create_paper_from_zotero)
            self._create_paper_from_zotero(db_session, item, item_key)
            return True, False
        ...
        for creator in creators:
            if creator.get('creatorType') == 'author':
                ...
                if author_name:
                    ...
                    # Use insert to set the position in the junction table
                    from src.models import paper_authors
                    db_session.execute(
